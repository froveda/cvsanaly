...
class ActionsControllerTest < ActionController::TestCase
  ...
  test "should create action" do
    assert_difference('Action.count') do
      post :create, action: { branch_id: @action.branch_id, commit_id: @action.commit_id, file_id: @action.file_id, type: @action.type }
    end
  ...
  test "should update action" do
    put :update, id: @action, action: { branch_id: @action.branch_id, commit_id: @action.commit_id, file_id: @action.file_id, type: @action.type }
    assert_redirected_to action_path(assigns(:action))
  end
